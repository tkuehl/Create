...
public class AdvancedDepotRenderer extends SafeBlockEntityRenderer<AdvancedDepotBlockEntity> {

	public AdvancedDepotRenderer(BlockEntityRendererProvider.Context context) {
	}

	@Override
	protected void renderSafe(AdvancedDepotBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
